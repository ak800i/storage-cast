...
- [ ] Cast an incompatible source (e.g. HEVC 10-bit MKV with E-AC-3 5.1). Video starts
      within a few seconds and plays smoothly (no green/garbled frames, no stutter).
